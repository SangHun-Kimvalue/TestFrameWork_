...
AgentClass::AgentClass() : select(3)
{
}

AgentClass::AgentClass(HWND hwnd) : m_hWndCopy(hwnd), select(1)
{
...
bool AgentClass::RGBSaveBMP(BYTE *input) {
