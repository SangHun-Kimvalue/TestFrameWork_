...
static void log_packet(const AVFormatContext *fmt_ctx, const AVPacket *pkt)
{
	...
	//printf("pts:%d pts_time:%s dts:%s dts_time:%s duration:%s duration_time:%s stream_index:%d\n",
	//	(char*)pkt->pts, (char*)(pkt->pts, time_base),
	//	(char*)(pkt->dts), (char*)(pkt->dts, time_base),
	//	(char*)(pkt->duration), (char*)(pkt->duration, time_base),
	//	pkt->stream_index);
}
...
int APIENTRY wWinMain(HINSTANCE hInstance,
	...
	filename = "rtsp://192.168.0.40:554/0";
